...
namespace Inflectra.POP3.Mime.Header
{
	/// <summary>
	...
	{
		private const string CLASS = "Inflectra.POP3.Mime.Header.HeaderFieldParser::";

		/// <summary>Parses the Content-Transfer-Encoding header.</summary>
		...
		{
			const string METHOD = CLASS + "ParseContentTransferEncoding()";
		...
		{
			const string METHOD = CLASS + "ParseImportance()";
