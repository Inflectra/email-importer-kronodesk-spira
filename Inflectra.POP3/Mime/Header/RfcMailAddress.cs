...
namespace Inflectra.POP3.Mime.Header
{
	...
	{
		private const string CLASS = "Inflectra.POP3.Mime.Header.RfcMailAddress::";
		...
		{
			const string METHOD = CLASS + "ParseMailAddress()";
			...
			catch (FormatException ex)
			{
				...
				//Logger.LogMessage(ex, "Improper mail address: '" + input + "'", METHOD);
			}
