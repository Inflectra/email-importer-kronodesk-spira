...
using System.Text;
using Inflectra.POP3.Mime.Decode;
...
namespace Inflectra.POP3.Mime
{
	...
	public class MessagePart
	{
		...
		/// <summary>Save this <see cref="MessagePart"/>'s contents to a file. There are no methods to reload the file.</summary>
		...
		/// <summary>Save this <see cref="MessagePart"/>'s contents to a stream.</summary>
		...
		/// <summary>Save this <see cref="MessagePart"/>'s contents to a local file.</summary>
