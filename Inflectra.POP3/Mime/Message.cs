...
using Inflectra.POP3.Mime.Traverse;

namespace Inflectra.POP3.Mime
{
	/// <summary>
	...
	public class Message
	{
		...
		/// <summary>Headers of the Message.</summary>
		public MessageHeader Headers { get; private set; }

		/// <summary>This is the body of the email Message.<br/><br/>If the body was parsed for this Message, this property will never be <see langword="null"/>.</summary>
		public MessagePart MessagePart { get; private set; }

		/// <summary>The raw content from which this message has been constructed.<br/>These bytes can be persisted and later used to recreate the Message.</summary>
		public byte[] RawMessage { get; private set; }

		/// <summary>The POP3 server's message UID. Not set internally.</summary>
		public string MessageUID { get; set; }

		/// <summary>The POP3's message index. Not set internally.</summary>
		public int MessageIndex { get; set; }

		/// <summary>A string to identify the message, used for logging.</summary>
		public string MessageLogID
		{
			get
			{
				return "#" + this.MessageIndex.ToString() + " - '" + this.MessageUID + "'";
			}
		}
		#endregion
