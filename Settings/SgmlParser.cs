...
namespace Inflectra.KronoDesk.Service.Email.Settings.Sgml
{
	/// <summary>Thrown if any errors occur while parsing the source.</summary>
	[Serializable]
	...
	/// <summary>The different types of literal text returned by the SgmlParser.</summary>
	public enum LiteralType
	{
		/// <summary>CDATA text literals.</summary>
		...
		/// <summary>SDATA entities.</summary>
		[SuppressMessage("Microsoft.Naming", "CA1705", Justification = "This capitalisation is appropriate since the value it represents has all upper-case capitalisation.")]
		SDATA,

		/// <summary>The contents of a Processing Instruction.</summary>
		[SuppressMessage("Microsoft.Naming", "CA1705", Justification = "This capitalisation is appropriate since the value it represents has all upper-case capitalisation.")]
		PI
	};

	/// <summary>An Entity declared in a DTD.</summary>
	public class Entity : IDisposable
	{
		/// <summary>The character indicating End Of File.</summary>
		...
		/// <summary>Initialises a new instance of an Entity declared in a DTD.</summary>
		...
		/// <summary>True if the entity is the html element entity.</summary>
		public bool IsHtml
		{
			get
			{
		...
		/// <summary>The public identifier of this entity.</summary>
		...
		/// <summary>The Uri that is the source for this entity.</summary>
		public string Uri
		{
			get
			{
		...
		/// <summary>The resolved location of the DTD this entity is from.</summary>
		...
		/// <summary>Gets the parent Entity of this Entity.</summary>
		...
		/// <summary>The last character read from the input stream for this entity.</summary>
		...
		/// <summary>The line on which this entity was defined.</summary>
		public int Line
		{
			get
			{
		...
		/// <summary>The index into the line where this entity is defined.</summary>
		...
		/// <summary>Whether this entity is an internal entity or not.</summary>
		...
		/// <summary>The literal value of this entity.</summary>
		...
		/// <summary>The <see cref="LiteralType"/> of this entity.</summary>
		...
		/// <summary>Whether the last char read for this entity is a whitespace character.</summary>
		...
		/// <summary>The proxy server to use when making web requests to resolve entities.</summary>
		public string Proxy
		{
			get
			{
		...
		/// <summary>Reads the next character from the DTD stream.</summary>
		...
		/// <summary>Begins processing an entity.</summary>
		...
		/// <summary>Gets the character encoding for this entity.</summary>
		...
		/// <summary>Closes the reader from which the entity is being read.</summary>
		public void Close()
		{
		...
		/// <summary>Returns the next character after any whitespace.</summary>
		...
		/// <summary>Scans a token from the input stream and returns the result.</summary>
		...
		/// <summary>Read a literal from the input stream.</summary>
		...
		/// <summary>Reads input until the end of the input stream or until a string of terminator characters is found.</summary>
		...
		/// <summary>Expands a character entity to be read from the input stream.</summary>
		...
		/// <summary>Raise a processing error.</summary>
		...
		/// <summary>Returns a string giving information on how the entity is referenced and declared, walking up the parents until the top level parent entity is found.</summary>
		...
		/// <summary>Checks whether a token denotes a literal entity or not.</summary>
		...
		/// <summary>Sets the entity to be a literal of the type specified.</summary>
		...
		/// <summary>The finalizer for the Entity class.</summary>
		~Entity()
		{
			Dispose(false);
		}
	...
	/// <summary>An element declaration in a DTD.</summary>
	public class ElementDecl
	{
		...
		/// <summary>Initialises a new element declaration instance.</summary>
		...
		/// <summary>The <see cref="Sgml.ContentModel"/> of the element declaration.</summary>
		...
		/// <summary>Whether the end tag of the element is optional.</summary>
		...
		/// <summary>Whether the start tag of the element is optional.</summary>
		...
		/// <summary>Finds the attribute definition with the specified name.</summary>
		...
		/// <summary>Adds attribute definitions to the element declaration.</summary>
		...
		/// <summary>Tests whether this element can contain another specified element.</summary>
	...
	/// <summary>Where nested subelements cannot occur within an element, its contents can be declared to consist of one of the types of declared content contained in this enumeration.</summary>
	public enum DeclaredContent
	{
		/// <summary>Not defined.</summary>
		Default,

		/// <summary>Character data (CDATA), which contains only valid SGML characters.</summary>
		[SuppressMessage("Microsoft.Naming", "CA1705", Justification = "This capitalisation is appropriate since the value it represents has all upper-case capitalisation.")]
		CDATA,

		/// <summary>Replaceable character data (RCDATA), which can contain text, character references and/or general entity references that resolve to character data.</summary>
		[SuppressMessage("Microsoft.Naming", "CA1705", Justification = "This capitalisation is appropriate since the value it represents has all upper-case capitalisation.")]
		RCDATA,

		/// <summary>Empty element (EMPTY), i.e. having no contents, or contents that can be generated by the program.</summary>
		[SuppressMessage("Microsoft.Naming", "CA1705", Justification = "This capitalisation is appropriate since the value it represents has all upper-case capitalisation.")]
		EMPTY
	}

	/// <summary>Defines the content model for an element.</summary>
	public class ContentModel
	{
		...
		/// <summary>Initialises a new instance of the <see cref="ContentModel"/> class.</summary>
		public ContentModel()
		{
			m_model = new Group(null);
		}

		/// <summary>The number of groups on the stack.</summary>
		...
		/// <summary>The allowed child content, specifying if nested children are not allowed and if so, what content is allowed.</summary>
		...
		/// <summary>Begins processing of a nested model group.</summary>
		...
		/// <summary>Finishes processing of a nested model group.</summary>
		...
		/// <summary>Adds a new symbol to the current group's members.</summary>
		...
		/// <summary>Adds a connector onto the member list for the current group.</summary>
		...
		/// <summary>Adds an occurrence character for the current model group, setting it's <see cref="Occurrence"/> value.</summary>
		...
		/// <summary>Sets the contained content for the content model.</summary>
		...
		/// <summary>Checks whether an element using this group can contain a specified element.</summary>
	...
	/// <summary>The type of the content model group, defining the order in which child elements can occur.</summary>
	public enum GroupType
	{
		/// <summary>No model group.</summary>
		None,

		/// <summary>All elements must occur, in any order.</summary>
		And,

		/// <summary>One (and only one) must occur.</summary>
		Or,

		/// <summary>All element must occur, in the specified order.</summary>
		Sequence
	};

	/// <summary>Qualifies the occurrence of a child element within a content model group.</summary>
	public enum Occurrence
	{
		/// <summary>The element is required and must occur only once.</summary>
		Required,

		/// <summary>The element is optional and must occur once at most.</summary>
		Optional,

		/// <summary>The element is optional and can be repeated.</summary>
		ZeroOrMore,

		/// <summary>The element must occur at least once or more times.</summary>
		OneOrMore
	}

	/// <summary>Defines a group of elements nested within another element.</summary>
	public class Group
	{
		...
		/// <summary>The <see cref="Occurrence"/> of this group.</summary>
		...
		/// <summary>Checks whether the group contains only text.</summary>
		...
		/// <summary>The parent group of this group.</summary>
		public Group Parent
		{
			get
			{
		...
		/// <summary>Initialises a new Content Model Group.</summary>
		...
		/// <summary>Adds a new child model group to the end of the group's members.</summary>
		...
		/// <summary>Adds a new symbol to the group's members.</summary>
		/// <param name="sym">The symbol to add.</param>
		public void AddSymbol(string sym)
		{
		...
		/// <summary>Adds a connector onto the member list.</summary>
		/// <param name="c">The connector character to add.</param>
		/// <exception cref="SgmlParseException">
		/// If the content is not mixed and has no members yet, or if the group type has been set and the
		/// connector does not match the group type.
		...
		/// <summary>Adds an occurrence character for this group, setting it's <see cref="Occurrence"/> value.</summary>
		/// <param name="c">The occurrence character.</param>
		public void AddOccurrence(char c)
		{
		...
		/// <param name="dtd">The DTD to use during the checking.</param>
		/// <returns>true if an element using this group can contain the element, otherwise false.</returns>
		/// <remarks>Rough approximation - this is really assuming an "Or" group</remarks>
		public bool CanContain(string name, SgmlDtd dtd)
		{
			if (dtd == null)
	...
	/// <summary>Defines the different possible attribute types.</summary>
	public enum AttributeType
	{
		/// <summary>Attribute type not specified.</summary>
		Default,

		/// <summary>The attribute contains text (with no markup).</summary>
		[SuppressMessage("Microsoft.Naming", "CA1705", Justification = "This capitalisation is appropriate since the value it represents has all upper-case capitalisation.")]
		CDATA,

		/// <summary>The attribute contains an entity declared in a DTD.</summary>
		[SuppressMessage("Microsoft.Naming", "CA1705", Justification = "This capitalisation is appropriate since the value it represents has all upper-case capitalisation.")]
		ENTITY,

		/// <summary>The attribute contains a number of entities declared in a DTD.</summary>
		[SuppressMessage("Microsoft.Naming", "CA1705", Justification = "This capitalisation is appropriate since the value it represents has all upper-case capitalisation.")]
		ENTITIES,

		/// <summary>The attribute is an id attribute uniquely identifie the element it appears on.</summary>
		[SuppressMessage("Microsoft.Naming", "CA1705", Justification = "This capitalisation is appropriate since the value it represents has all upper-case capitalisation.")]
		...
		/// <summary>The attribute value can be any declared subdocument or data entity name.</summary>
		[SuppressMessage("Microsoft.Naming", "CA1705", Justification = "This capitalisation is appropriate since the value it represents has all upper-case capitalisation.")]
		IDREF,

		/// <summary>The attribute value is a list of (space separated) declared subdocument or data entity names.</summary>
		[SuppressMessage("Microsoft.Naming", "CA1705", Justification = "This capitalisation is appropriate since the value it represents has all upper-case capitalisation.")]
		IDREFS,

		/// <summary>The attribute value is a SGML Name.</summary>
		[SuppressMessage("Microsoft.Naming", "CA1705", Justification = "This capitalisation is appropriate since the value it represents has all upper-case capitalisation.")]
		NAME,

		/// <summary>The attribute value is a list of (space separated) SGML Names.</summary>
		[SuppressMessage("Microsoft.Naming", "CA1705", Justification = "This capitalisation is appropriate since the value it represents has all upper-case capitalisation.")]
		NAMES,

		/// <summary>The attribute value is an XML name token (i.e. contains only name characters, but in this case with digits and other valid name characters accepted as the first character).</summary>
		[SuppressMessage("Microsoft.Naming", "CA1705", Justification = "This capitalisation is appropriate since the value it represents has all upper-case capitalisation.")]
		NMTOKEN,

		/// <summary>The attribute value is a list of (space separated) XML NMTokens.</summary>
		[SuppressMessage("Microsoft.Naming", "CA1705", Justification = "This capitalisation is appropriate since the value it represents has all upper-case capitalisation.")]
		NMTOKENS,

		/// <summary>The attribute value is a number.</summary>
		[SuppressMessage("Microsoft.Naming", "CA1705", Justification = "This capitalisation is appropriate since the value it represents has all upper-case capitalisation.")]
		NUMBER,

		/// <summary>The attribute value is a list of (space separated) numbers.</summary>
		[SuppressMessage("Microsoft.Naming", "CA1705", Justification = "This capitalisation is appropriate since the value it represents has all upper-case capitalisation.")]
		NUMBERS,

		/// <summary>The attribute value is a number token (i.e. a name that starts with a number).</summary>
		[SuppressMessage("Microsoft.Naming", "CA1705", Justification = "This capitalisation is appropriate since the value it represents has all upper-case capitalisation.")]
		NUTOKEN,

		/// <summary>The attribute value is a list of number tokens.</summary>
		[SuppressMessage("Microsoft.Naming", "CA1705", Justification = "This capitalisation is appropriate since the value it represents has all upper-case capitalisation.")]
		NUTOKENS,

		/// <summary>Attribute value is a member of the bracketed list of notation names that qualifies this reserved name.</summary>
		[SuppressMessage("Microsoft.Naming", "CA1705", Justification = "This capitalisation is appropriate since the value it represents has all upper-case capitalisation.")]
		NOTATION,

		/// <summary>The attribute value is one of a set of allowed names.</summary>
		[SuppressMessage("Microsoft.Naming", "CA1705", Justification = "This capitalisation is appropriate since the value it represents has all upper-case capitalisation.")]
		ENUMERATION
	}

	/// <summary>Defines the different constraints on an attribute's presence on an element.</summary>
	public enum AttributePresence
	{
		/// <summary>The attribute has a default value, and its presence is optional.</summary>
		Default,

		/// <summary>The attribute has a fixed value, if present.</summary>
		Fixed,

		/// <summary>The attribute must always be present on every element.</summary>
		Required,

		/// <summary>The element is optional.</summary>
		Implied
	}

	/// <summary>An attribute definition in a DTD.</summary>
	public class AttDef
	{
		private string m_name;
		...
		/// <summary>Initialises a new instance of the <see cref="AttDef"/> class.</summary>
		...
		/// <summary>The name of the attribute declared by this attribute definition.</summary>
		public string Name
		{
			get
			{
		...
		/// <summary>Gets of sets the default value of the attribute.</summary>
		...
		/// <summary>The constraints on the attribute's presence on an element.</summary>
		...
		/// <summary>Gets or sets the possible enumerated values for the attribute.</summary>
		...
		/// <summary>Sets the attribute definition to have an enumerated value.</summary>
		...
		/// <summary>The <see cref="AttributeType"/> of the attribute declaration.</summary>
		...
		/// <summary>Sets the type of the attribute definition.</summary>
		...
		/// <summary>Sets the attribute presence declaration.</summary>
	...
	/// <summary>Provides DTD parsing and support for the SgmlParser framework.</summary>
	public class SgmlDtd
	{
		...
		/// <summary>Initialises a new instance of the <see cref="SgmlDtd"/> class.</summary>
		...
		/// <summary>The name of the DTD.</summary>
		public string Name
		{
			get
			{
		...
		/// <summary>Parses a DTD and creates a <see cref="SgmlDtd"/> instance that encapsulates the DTD.</summary>
		...
		/// <summary>Finds an entity in the DTD with the specified name.</summary>
		...
		/// <summary>Finds an element declaration in the DTD with the specified name.</summary>
		...
		/// <summary>Returns a dictionary for looking up entities by their <see cref="Entity.Literal"/> value.</summary>
