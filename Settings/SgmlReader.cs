...
{
	/// <summary>SGML is case insensitive, so here you can choose between converting to lower case or upper case tags.  "None" means that the case is left alone, except that end tags will be folded to match the start tags.</summary>
	public enum CaseFolding
	{
		/// <summary>Do not convert case, except for converting end tags to match start tags.</summary>
		None,

		/// <summary>Convert tags to upper case.</summary>
		ToUpper,

		/// <summary>Convert tags to lower case.</summary>
		ToLower
	}

	/// <summary>This stack maintains a high water mark for allocated objects so the client can reuse the objects in the stack to reduce memory allocations, this is used to maintain current state of the parser for element stack, and attributes in each element.</summary>
	internal class HWStack
	{
		...
		/// <summary>Initialises a new instance of the HWStack class.</summary>
		...
		/// <summary>The number of items currently in the stack.</summary>
		public int Count
		{
			get
			{
		...
		/// <summary>The size (capacity) of the stack.</summary>
		...
		/// <summary>Returns the item at the requested index or null if index is out of bounds</summary>
		...
		/// <summary>Pushes a new slot at the top of the stack.</summary>
		/// <returns>The object at the top of the stack.</returns>
		/// <remarks>This method tries to reuse a slot, if it returns null then the user has to call the other Push method.</remarks>
		public object Push()
		{
		...
		/// <summary>Remove a specific item from the stack.</summary>
	...
	/// <summary>This class represents an attribute.  The AttDef is assigned from a validation process, and is used to provide default values.</summary>
	internal class Attribute
	{
		...
		/// <summary>Attribute objects are reused during parsing to reduce memory allocations, hence the Reset method.</summary>
	...
	/// <summary>This class models an XML node, an array of elements in scope is maintained while parsing for validation purposes, and these Node objects are reused to reduce object allocation, hence the reset method.  </summary>
	internal class Node
	{
	...
	/// <summary>SgmlReader is an XmlReader API over any SGML document (including built in  support for HTML).  </summary>
	public class SgmlReader : XmlReader
	{
		/// <summary>The value returned when a namespace is queried and none has been specified.</summary>
		...
		/// <summary>Initialises a new instance of the SgmlReader class.</summary>
		public SgmlReader()
		{
			Init();
		}

		/// <summary>Initialises a new instance of the SgmlReader class with an existing <see cref="XmlNameTable"/>, which is NOT used.</summary>
		...
		/// <summary>Specify the SgmlDtd object directly.  This allows you to cache the Dtd and share it across multipl SgmlReaders.  To load a DTD from a URL use the SystemLiteral property.</summary>
		public SgmlDtd Dtd
		{
			get
			{
		...
		/// <summary>The name of root element specified in the DOCTYPE tag.</summary>
		...
		/// <summary>The root element of the document.</summary>
		...
		/// <summary>The PUBLIC identifier in the DOCTYPE tag</summary>
		...
		/// <summary>The SYSTEM literal in the DOCTYPE tag identifying the location of the DTD.</summary>
		...
		/// <summary>The DTD internal subset in the DOCTYPE tag</summary>
		...
		/// <summary>The input stream containing SGML data to parse. You must specify this property or the Href property before calling Read().</summary>
		...
		/// <summary>Sometimes you need to specify a proxy server in order to load data via HTTP from outside the firewall.  For example: "itgproxy:80".</summary>
		...
		/// <summary>The base Uri is used to resolve relative Uri's like the SystemLiteral and Href properties.  This is a method because BaseURI is a read-only property on the base XmlReader class.</summary>
		public void SetBaseUri(string uri)
		{
			this.m_baseUri = new Uri(uri);
		}

		/// <summary>Specify the location of the input SGML document as a URL.</summary>
		public string Href
		{
			get
			{
		...
		/// <summary>Whether to strip out the DOCTYPE tag from the output (default true)</summary>
		...
		/// <summary>Gets or sets a value indicating whether to ignore any DTD reference.</summary>
		...
		/// <summary>The case conversion behaviour while processing tags.</summary>
		...
		/// <summary>DTD validation errors are written to this stream.</summary>
		...
		/// <summary>DTD validation errors are written to this log file.</summary>
		...
		/// <summary>The node type of the node currently being parsed.</summary>
		...
		/// <summary>The name of the current node, if currently positioned on a node or attribute.</summary>
		...
		/// <summary>The local name of the current node, if currently positioned on a node or attribute.</summary>
		...
		/// <summary>The namespace of the current node, if currently positioned on a node or attribute.</summary>
		/// <remarks>If not positioned on a node or attribute, <see cref="UNDEFINED_NAMESPACE"/> is returned.</remarks>
		...
		/// <summary>The prefix of the current node's name.</summary>
		...
		/// <summary>Whether the current node has a value or not.</summary>
		...
		/// <summary>The value of the current node.</summary>
		...
		/// <value>true if the current node is an attribute whose value was generated from the default value defined in the DTD or schema; false if the attribute value was explicitly set.</value>
		...
		/// <remarks>This property applies only to an attribute node.</remarks>
		...
		/// <summary>Gets the value of an attribute with the specified <see cref="Name"/>.</summary>
		...
		/// <summary>Gets the value of the attribute with the specified <see cref="LocalName"/> and <see cref="NamespaceURI"/>.</summary>
		...
		/// <summary>Moves to the atttribute with the specified <see cref="Name"/>.</summary>
		...
		/// <summary>Moves to the attribute with the specified <see cref="LocalName"/> and <see cref="NamespaceURI"/>.</summary>
		/// <param name="name">The local name of the attribute.</param>
		...
		/// <remarks>If the current node is an element node, this method is equivalent to <see cref="MoveToFirstAttribute"/>. If <see cref="MoveToNextAttribute"/> returns true, the reader moves to the next attribute; otherwise, the position of the reader does not change.</remarks>
		...
		/// <summary>Gets whether the content is HTML or not.</summary>
		public bool IsHtml
		{
			get
			{
		...
		/// <summary>Returns the encoding of the current entity.</summary>
		...
		/// <summary>Consumes and returns a literal block of text, expanding entities as it does so.</summary>
		...
		/// <remarks>This version is slightly different from <see cref="Entity.ScanLiteral"/> in that it also expands entities.</remarks>
		...
		/// <summary>Changes the <see cref="ReadState"/> to Closed.</summary>
		...
		/// <summary>Reads all the content, including markup, as a string.</summary>
		...
		/// <summary>Reads the content, including markup, representing this node and all its children.</summary>
